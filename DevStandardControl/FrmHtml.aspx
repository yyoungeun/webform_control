...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:HyperLink ID ="lnkDotNetKorea" runat="server" NavigateUrl="http://www.dotnetkorea.com/">닷넷 코리아</asp:HyperLink>
            <br />

            이미지 :
            <img src="./images/btn_home.gif" alt="홈으로..." title="홈으로.." />
            <asp:Image ID="imgHome" runat="server" ImageUrl="./images/btn_home.gif" ToolTip="홈으로.." AlternateText="홈으로.." /><br />
            <br />
            
            이미지맵 :
           <img src="./images/btn_home.gif" border="0" usemap="#GoHome" />
            <map name="GoHome">
                <area shape="circle" coords="16, 16, 5" href="http://www.dotnetkorea.com/" alt="닷넷 코리아" target="_blank" />
            ...
            <asp:ImageMap ID="mapHome" runat="server" ImageUrl="./images/btn_home.gif">
                <asp:RectangleHotSpot AlternateText="태오닷넷" Bottom="5" HotSpotMode="Navigate" NavigateUrl="http://taeyo.net" Right="5" Target="_blank" />
                <asp:CircleHotSpot AlternateText="닷넷코리아" HotSpotMode ="Navigate" NavigateUrl="http://www.dotnetkorea.com/" Radius="5" Target="_blank" X="16" Y="16" />
            </asp:ImageMap><br />
            <br />-
